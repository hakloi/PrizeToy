public class Lottery {
    public static void main(String[] args) {
        ...
        Toy toy4 = new Toy(4, "Teddy Bear", 40, 80);
        Toy toy5 = new Toy(5, "Cinema ticket", 50, 50);
        Toy toy6 = new Toy(6, "Magazine", 60, 60);
        Toy toy7 = new Toy(7, "Multi-pulti Buba", 80, 70);
        Toy toy8 = new Toy(8, "Blocks", 90, 90);
        Toy toy9 = new Toy(9, "Board game", 70, 30);
